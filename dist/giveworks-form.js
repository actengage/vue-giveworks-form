...
var Api = function () {
    ...
    createClass(Api, [{
        ...
        value: function get$$1(url, options) {
            return axios.get(url, lodashEs.extend(options, HttpConfig.defaultRequestOptions));
        }
    }, {
        key: 'post',
        value: function post(url, data, options) {
            return axios.post(url, data, lodashEs.extend(options, HttpConfig.defaultRequestOptions));
        }
    }, {
        key: 'put',
        value: function put(url, data, options) {
            return axios.put(url, data, lodashEs.extend(options, HttpConfig.defaultRequestOptions));
        }
    }, {
        key: 'delete',
        value: function _delete(url, options) {
            return axios.delete(url, lodashEs.extend(options, HttpConfig.defaultRequestOptions));
        }
    }, {
        key: 'baseUrl',
        value: function baseUrl() {
            return lodashEs.trimEnd(HttpConfig.baseUrl, '/');
        }
    }, {
        key: 'url',
        value: function url() {
        ...
        value: function registerEndpoints(endpoints) {
            ...
            lodashEs.each(endpoints, function (endpoint, key) {
...
var SelectField = { render: function render() {
    ...
    computed: {
        selectOptions: function selectOptions() {
            if (lodashEs.isArray(this.options)) {
                return this.options;
            }
...
var Stripe = function (_Api) {
    ...
    createClass(Stripe, [{
        ...
        value: function card(options) {
            ...
            return this.elements().create('card', lodashEs.extend({ style: style }, options));
        }
    }, {
        key: 'elements',
...
var ActivityIndicatorSpinner = {
    ...
    props: lodashEs.extend({}, BaseType.props, {
        nodes: {
            type: Number,
            default: 12
        }
...
var ActivityIndicator = { render: function render() {
    ...
    computed: {
        component: function component() {
            return lodashEs.kebabCase(this.prefix + this.type.replace(this.prefix, ''));
        }
    }
...
var PaymentGateways = { render: function render() {
        ...
        })), _vm._v(" "), _c('hr'), _vm._v(" "), _vm._l(_vm.buttons, function (button) {
    ...
    methods: {
        getButtons: function getButtons() {
            ...
            lodashEs.each(this.page.site.gateways, function (gateway) {
                ...
                lodashEs.each(Gateway(gateway).buttons(), function (button) {
                    button.active = false;
        ...
        deactivate: function deactivate() {
            lodashEs.each(this.buttons, function (button) {
                button.active = false;
            });
        },
...
var GiveworksForm = { render: function render() {
    ...
    beforeCreate: function beforeCreate() {
        ...
        lodashEs.each(replies, function (method, name) {

...
/** Built-in value references. */
var propertyIsEnumerable$2 = objectProto$12.propertyIsEnumerable;
...
typedArrayTags$1[dataViewTag$2] = typedArrayTags$1[dateTag$2] =
typedArrayTags$1[errorTag$2] = typedArrayTags$1[funcTag$3] =
typedArrayTags$1[mapTag$2] = typedArrayTags$1[numberTag$2] =
typedArrayTags$1[objectTag$1] = typedArrayTags$1[regexpTag$2] =
typedArrayTags$1[setTag$2] = typedArrayTags$1[stringTag$2] =
...
/** Used to check objects for own properties. */
var hasOwnProperty$12 = objectProto$17.hasOwnProperty;
...
function assignValue(object, key, value) {
  var objValue = object[key];
  if (!(hasOwnProperty$13.call(object, key) && eq(objValue, value)) ||
...
function reduce(collection, iteratee, accumulator) {
  ...
  return func(collection, baseIteratee(iteratee, 4), accumulator, initAccum, baseEach$1);
}
...
function baseClone(value, bitmask, customizer, key, object, stack) {
  ...
  if (isArr) {
    ...
    if (tag == objectTag$4 || tag == argsTag$5 || (isFunc && !object)) {
...
function isPlainObject(value) {
  ...
  var Ctor = hasOwnProperty$18.call(proto, 'constructor') && proto.constructor;
...
function merge() {
    ...
    for(let i in items) {
        subject = mergeWith(subject, items[i], (subject, value) => {
            if(isArray$1(subject)) {
                return subject.concat(value);
            }
            else if(isObject$1(subject)) {
...
class Request {
    ...
    constructor(url, options = {}) {
        ...
        forEach$1(PROXY_OPTION_METHODS, (callback, key) => {
            this[method(key, 'option')] = bind(callback)('$options', this);
        });

        forEach$1(PROXY_OPTION_PROPERTIES, (prop) => {
            forEach$1(PROXY_OPTION_METHODS, (callback, key) => {
...
class Model {
     ...
     */
    get(key) {
        if(isArray$1(key) || isObject$1(key)) {
    ...
    getUnchangedAttributes() {
        return filter(keys$1(this.$attributes), key => !(key in this.$changed));
    }
     ...
     */
    revert() {
        forEach$1(this.$changed, (value, key) => {
            if(!isUndefined(value)) {
                this.$attributes[key] = value;
            }
            else {
    ...
    toFormData() {
        ...
        forEach$1(this.toJSON(), (value, key) => {
            if(isArray$1(value)) {
                forEach$1(value, item => {
...
function hashHas$1(key) {
  var data = this.__data__;
  return nativeCreate$1 ? (data[key] !== undefined) : hasOwnProperty$21.call(data, key);
}
...
// Fallback for data views, maps, sets, and weak maps in IE 11 and promises in Node.js < 6.
if ((DataView$1 && getTag$2(new DataView$1(new ArrayBuffer(1))) != dataViewTag$7) ||
    (Map$1 && getTag$2(new Map$1) != mapTag$9) ||
    (Promise$2 && getTag$2(Promise$2.resolve()) != promiseTag$1) ||
    (Set$1 && getTag$2(new Set$1) != setTag$9) ||
    (WeakMap$1 && getTag$2(new WeakMap$1) != weakMapTag$4)) {
...
function baseIsEqualDeep$1(object, other, bitmask, customizer, equalFunc, stack) {
  var objIsArr = isArray(object),
      ...
      objTag = objIsArr ? arrayTag$4 : getTag$3(object),
      othTag = othIsArr ? arrayTag$4 : getTag$3(other);
...
function baseIsMatch$1(object, source, matchData, customizer) {
  ...
  while (++index < length) {
    ...
    if (noCustomizer && data[2]) {
      ...
      if (!(result === undefined
            ? baseIsEqual$1(srcValue, objValue, COMPARE_PARTIAL_FLAG$10 | COMPARE_UNORDERED_FLAG$6, customizer, stack)
            : result
          )) {
        return false;
      }
...
function isSymbol$1(value) {
  return typeof value == 'symbol' ||
    (isObjectLike(value) && baseGetTag(value) == symbolTag$5);
}
...
function baseMatchesProperty$1(path, srcValue) {
  ...
  return function(object) {
    ...
    return (objValue === undefined && objValue === srcValue)
      ? hasIn$1(object, path)
      : baseIsEqual$1(srcValue, objValue, COMPARE_PARTIAL_FLAG$11 | COMPARE_UNORDERED_FLAG$7);
  };
}
...
function assignValue$1(object, key, value) {
  var objValue = object[key];
  if (!(hasOwnProperty$24.call(object, key) && eq$1(objValue, value)) ||
      (value === undefined && !(key in object))) {
...
function keysIn$2(object) {
  return isArrayLike(object) ? arrayLikeKeys(object, true) : baseKeysIn$1(object);
}
...
function omitBy(object, predicate) {
  return pickBy$1(object, negate(baseIteratee$1(predicate)));
}
...
function isEmpty(value) {
  ...
  for (var key in value) {
    if (hasOwnProperty$26.call(value, key)) {
      return false;
    }
  }
  return true;
    ...
    methods: {
        ...
        onAutofill(place) {
            ...
            forEach(addressComponents, (parts, field) => {
                const part = compact(map$1(place.address_components, component => {
...
/** Built-in value references. */
var Buffer$3 = moduleExports$5 ? root.Buffer : undefined,
...
var funcProto$5 = Function.prototype,
    objectProto$33 = Object.prototype;
...
function isPlainObject$1(value) {
  if (!isObjectLike(value) || baseGetTag(value) != objectTag$8) {
    return false;
  }
  ...
  var Ctor = hasOwnProperty$27.call(proto, 'constructor') && proto.constructor;
  return typeof Ctor == 'function' && Ctor instanceof Ctor &&
...
class Stripe extends Gateway {
    ...
    card(options) {
        ...
        return this.elements().create('card', assignIn$1({style: style}, options));
    }
...
function chunk(array, size, guard) {
  if ((guard ? isIterateeCall$1(array, size, guard) : size === undefined)) {
    ...
    size = nativeMax$6(toInteger$1(size), 0);
  }
  var length = array == null ? 0 : array.length;
  if (!length || size < 1) {
    return [];
...
function omitBy$1(object, predicate) {
  return pickBy(object, negate$1(baseIteratee(predicate)));
}

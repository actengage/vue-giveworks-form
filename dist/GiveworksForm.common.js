...
// CONCATENATED MODULE: ./src/Components/GiveworksForm.vue?vue&type=template&id=0db9b7c9&
...
/* harmony default export */ var GiveworksFormvue_type_script_lang_js_ = ({
  ...
  methods: {
    submit(e) {
      this.$refs.type.submit(e).then(this.$refs.type.onSubmitSuccess, this.$refs.type.onSubmitError).then(() => {

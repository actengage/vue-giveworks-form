(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('lodash-es'), require('vue-awesome/icons/cc-credit-card'), require('moment')) :
	typeof define === 'function' && define.amd ? define(['lodash-es', 'vue-awesome/icons/cc-credit-card', 'moment'], factory) :
	(global.GiveworksForm = factory(global['lodash-es'],null,global.moment));
}(this, (function (lodashEs,ccCreditCard,moment) { 'use strict';
...
var StripePaymentButton = { render: function render() {
        var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', [!_vm.loaded || _vm.submitting ? _c('div', { staticClass: "row my-5 py-1" }, [_c('div', { staticClass: "col-xs-12" }, [_c('activity-indicator', { attrs: { "size": "sm", "center": true } })], 1)]) : !_vm.error ? _c('div', [_vm.card ? _c('div', { staticClass: "my-3" }, [_c('button', { staticClass: "btn btn-xs btn-warning", staticStyle: { "float": "right" }, attrs: { "type": "button" }, on: { "click": function click($event) {
                ...
                } } }, [_vm._v("Change Card")]), _vm._v(" "), _c('div', { staticClass: "row" }, [_c('div', { staticClass: "col-xs-3" }, [_c('div', { staticClass: "mr-6" }, [_vm.card.brand === 'Visa' ? _c('icon', { attrs: { "name": "cc-visa", "scale": "4" } }) : _vm._e(), _vm._v(" "), _vm.card.brand === 'MasterCard' ? _c('icon', { attrs: { "name": "cc-mastercard", "scale": "4" } }) : _vm._e(), _vm._v(" "), _vm.card.brand === 'American Express' ? _c('icon', { attrs: { "name": "cc-amex", "scale": "4" } }) : _vm._e(), _vm._v(" "), _vm.card.brand === 'Discover' ? _c('icon', { attrs: { "name": "cc-discover", "scale": "4" } }) : _vm._e(), _vm._v(" "), _vm.card.brand === 'JCB' ? _c('icon', { attrs: { "name": "cc-jcb", "scale": "4" } }) : _vm._e(), _vm._v(" "), _vm.card.brand === 'Diners Club' ? _c('icon', { attrs: { "name": "cc-diners-club", "scale": "4" } }) : _c('icon', { attrs: { "name": "cc-credit-card", "scale": "4" } })], 1)]), _vm._v(" "), _c('div', { staticClass: "col-xs-9" }, [_c('button', { staticClass: "btn btn-xs btn-warning", staticStyle: { "float": "right" }, attrs: { "type": "button" } }, [_vm._v("Change Card")]), _vm._v(" "), _vm.card.name ? _c('span', [_vm._v(_vm._s(_vm.card.name)), _c('br')]) : _vm._e(), _vm._v(" ****" + _vm._s(_vm.card.last4) + " "), _c('span', { staticClass: "pl-2" }, [_vm._v(_vm._s(_vm.card.exp_month) + "/" + _vm._s(_vm.card.exp_year))])])])]) : _vm._e(), _vm._v(" "), _c('div', { staticClass: "stripe-payment-button mt-2 mb-4" })]) : _c('div', { staticClass: "alert alert-danger" }, [_c('div', { staticClass: "row" }, [_c('div', { staticClass: "col-xs-3 text-center" }, [_c('icon', { staticClass: "mt-2", attrs: { "name": "warning", "scale": "2" } })], 1), _vm._v(" "), _c('div', { staticClass: "col-xs-9" }, [_vm._v(" " + _vm._s(_vm.error.message) + " ")])])])]);
    }, staticRenderFns: [],
...
var PaymentGateways = { render: function render() {
    ...
    data: function data() {
        ...
        lodashEs.each(this.page.site.gateways, function (gateway) {
            ...
            lodashEs.merge(buttons, gatewayButtons);
        });

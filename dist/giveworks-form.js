...
var FormComponent = { render: function render() {
        var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _vm.page ? _c('form', { on: { "submit": function submit($event) {
                    $event.preventDefault();_vm.onSubmit($event);
                } } }, [_vm._v(" " + _vm._s(_vm.page) + " "), _c('button', { attrs: { "type": "submit" } }, [_vm._v("Submit")])]) : _vm.error ? _c('div', [_c('http-error-response', { attrs: { "error": _vm.error } })], 1) : _c('div', [_c('activity-indicator')], 1);
    }, staticRenderFns: [],
...
var GiveworksForm = function () {
    function GiveworksForm(el, options) {
        classCallCheck(this, GiveworksForm);

        this.setApp(el);
    }

    createClass(GiveworksForm, [{
        key: 'setApp',

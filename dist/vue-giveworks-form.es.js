...
var StreetField = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('place-autocomplete-field',{directives:[{name:"place-autofill",rawName:"v-place-autofill.street",value:(_vm.form.street),expression:"form.street",modifiers:{"street":true}},{name:"place-autofill",rawName:"v-place-autofill.city",value:(_vm.form.city),expression:"form.city",modifiers:{"city":true}},{name:"place-autofill",rawName:"v-place-autofill.state",value:(_vm.form.state),expression:"form.state",modifiers:{"state":true}},{name:"place-autofill",rawName:"v-place-autofill.zip",value:(_vm.form.zip),expression:"form.zip",modifiers:{"zip":true}}],attrs:{"errors":_vm.errors,"label":_vm.question.question,"id":"street","name":"street","placeholder":"Street Address","api-key":"AIzaSyAhSv9zWvisiTXRPRw6K8AE0DCmrRMpQcU"},on:{"input":_vm.updated},model:{value:(_vm.value),callback:function ($$v) {_vm.value=$$v;},expression:"value"}})},staticRenderFns: [],
...
function equalByTag$1(object, other, tag, bitmask, customizer, equalFunc, stack) {
  switch (tag) {
    ...
    case setTag$2$1:
      ...
      bitmask |= COMPARE_UNORDERED_FLAG$1$1;
...
var rsMiscLower$1 = '(?:' + rsLower$1 + '|' + rsMisc$1 + ')',
    ...
    reOptMod$1$1 = rsModifier$1$1 + '?',
    rsOptVar$1$1 = '[' + rsVarRange$2$1 + ']?',
    rsOptJoin$1$1 = '(?:' + rsZWJ$2$1 + '(?:' + [rsNonAstral$1$1, rsRegional$1$1, rsSurrPair$1$1].join('|') + ')' + rsOptVar$1$1 + reOptMod$1$1 + ')*',
